...
From <http://www.cokeandcode.com/info/tut2d.html>
...
The final game can be see [here][6]. The complete source for the tutorial can be found [here][7]. Its intended that you read through this tutorial with the source code at your side. The tutorial isn't going to cover every line of code but should give you enough to fully understand how it works. 

   [6]: http://www.cokeandcode.com/spaceinvaders/si101.jnlp
   [7]: http://www.cokeandcode.com/spaceinvaders/spaceinvaders.zip
...
[AlienEntity.java][14]
   ...
   [8]: showsrc/showsrc.php?src=../spaceinvaders/org/newdawn/spaceinvaders/Game.java
   [9]: showsrc/showsrc.php?src=../spaceinvaders/org/newdawn/spaceinvaders/SpriteStore.java
   [10]: showsrc/showsrc.php?src=../spaceinvaders/org/newdawn/spaceinvaders/Sprite.java
   [11]: showsrc/showsrc.php?src=../spaceinvaders/org/newdawn/spaceinvaders/Entity.java
   [12]: showsrc/showsrc.php?src=../spaceinvaders/org/newdawn/spaceinvaders/ShipEntity.java
   [13]: showsrc/showsrc.php?src=../spaceinvaders/org/newdawn/spaceinvaders/ShotEntity.java
   [14]: showsrc/showsrc.php?src=../spaceinvaders/org/newdawn/spaceinvaders/AlienEntity.java

_ Disclaimer: This tutorial is provided as is. I don't guarantee that the provided source is perfect or that that it provides best practices. _
...
The game loop is a remarkably important part of any game. Client side games tend to be single threaded. This helps prevent a whole bunch of complexities synchronizing game updates and game drawing. Generally this results in more stable and maintainable code. There are good arguments to use threading, however for the purposes of this tutorial we're not going to consider it. 
...
A singleton simply means thats theres a single instance of the object available statically. In many cases this is done simply for convenience, however sometimes there are good design reasons for enforcing that there is only a single instance of the class ever created. 
...
Its important to note that the chain of functions used to get to the class is only there to support specialized class loaders (like the one found in WebStart). The retrieved URL will point to the image specified in the string "ref" relative to the classpath. 
...
If you have any comments or corrects feel free to mail me [here][15]

   [15]: kevin@newdawnsoftware.com
...
* [A HowTo Guide for WebStart][16]
* [The SUN fullscreen tutorial trail][17]
* [The GAGE Library (Most importantly the high resolution timer)][18]

   [16]: http://www.cokeandcode.com/info/webstart-howto.html
   [17]: http://java.sun.com/docs/books/tutorial/extra/fullscreen/
   [18]: http://java.dnsalias.com
...
Tutorial and Source written by [Kevin Glass][19]   
Game sprites provided by [Ari Feldman][20]   
A large number of people over at the [Java Gaming Forums][21]   


   [19]: mailto:kevin@newdawnsoftware.com
   [20]: http://www.arifeldman.com/games/spritelib.html
   [21]: http://www.javagaming.org/cgi-bin/JGNetForums/YaBB.cgi
